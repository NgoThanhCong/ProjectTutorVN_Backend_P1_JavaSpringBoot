...
import com.greenwich.tutorvn.payload.request.LoginRequest;
import com.greenwich.tutorvn.payload.request.SignupRequest;
import com.greenwich.tutorvn.payload.response.JwtResponse;
import com.greenwich.tutorvn.payload.response.MessageResponse;
...
import com.greenwich.tutorvn.service.UserDetailsImpl;
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
        ...
        System.out.println("loginRequest1:"+ loginRequest.getUsername());
        System.out.println("loginRequest2:"+ loginRequest.getPassword());

...
import com.greenwich.tutorvn.constants.Constant;
import com.greenwich.tutorvn.model.ResponseObject;
import com.greenwich.tutorvn.service.IStorageService;
    ...
    public ResponseEntity<ResponseObject> uploadFile(@RequestParam("file")MultipartFile file) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.OK).body(
                    new ResponseObject(200, "upload file successfully",
                            Constant.url + "/api/v1/FileUpload/files/" +  generatedFileName)
            );
